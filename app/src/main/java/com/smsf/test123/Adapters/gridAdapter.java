package com.smsf.test123.Adapters;
...
import static com.smsf.test123.history.historyActivity.deleList;
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(i%2==0) {
                    ...
                    button.setChecked(true);
                    deleList.add(f.getAbsolutePath());
                    button1.setChecked(false);
                    i+=1;
                }
                else {
                    button.setChecked(false);
                    deleList.remove(f.getAbsolutePath());
