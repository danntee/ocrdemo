 ...
 */
package com.smsf.test123.ocrActivites;
            ...
            public void onResult(IDCardResult result) {
                if (result != null) {
                    Intent intent=new Intent(IDCardActivity.this, FresultActivity.class);
                       try {
                           intent.putExtra("name", result.getName().getWords());
                           intent.putExtra("birthday", result.getBirthday().getWords());
                           intent.putExtra("id", result.getIdNumber().getWords());
                           intent.putExtra("address", result.getAddress().getWords());
                           intent.putExtra("ocrResult",result.getName().getWords()+"\n"+result.getBirthday().getWords()+"\n"+result.getAddress().getWords()+"\n"+result.getIdNumber().getWords());
                       }
