...
import com.smsf.allroundscan.Jutils.FileUtil;
import com.smsf.allroundscan.Jutils.HttpUtil;
...
public class FormOcrRequest {
     ...
     * 下载
     */
    public static String formOcrRequest(String token,String filepath) {
        // 请求url
